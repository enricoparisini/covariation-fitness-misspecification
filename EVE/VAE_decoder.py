...
class VAE_Standard_MLP_decoder(nn.Module):
    ...
    """
    def __init__(self, params):
                #  seq_len, alphabet_size, hidden_layers_sizes, z_dim, first_hidden_nonlinearity, last_hidden_nonlinearity, dropout_proba,
        ...
        #nn.init.normal_(self.W_out) #Initialize weights with normal distribution

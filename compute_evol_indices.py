...
if __name__=='__main__':
    ...
    parser.add_argument('--checkpoint_file_name', type=str, help='Location of VAE model to load')
    ...
    try:
        ...
        checkpoint_name = str(args.VAE_checkpoint_location) + os.sep + args.checkpoint_file_name
    ...
    evol_indices_output_filename = args.output_evol_indices_location+os.sep+protein_name+'_'+args.output_evol_indices_filename_suffix+'.csv'
    try:
